...
function HomeScreen() {
    ...
    return (
        <>
            ...
            <div className='flex justify-between my-6 mx-44'>
                <div className='w-auto flex items-start flex-col'>
                    <div className='flex items-center justify-center font-extrabold'>
                        <span className='text-darkOrange text-8xl text-shadow-md shadow-[#00000047]'>10+</span>
                        <span className='text-4.5xl ml-5'>Expert Partner Labs across India</span>
                    </div>

                    <div className='font-medium text-3.5xl my-5'>
                    ...
                    <div className='font-medium text-darkOrange text-2xl mt-3'>
                        Pratik Sinha
                    </div>
                </div>
                ...
                <div className='w-fit flex flex-col justify-end items-end'>
                    <div>
                        <div className="text-8.5xl font-medium ml-6 -mb-8">A+</div>
                        <div className='flex'>
                            {
            ...
            <div className='bg-darkOrange flex flex-col items-center self-stretch gap-12 px-40 py-16'>
                <div className="text-center text-white text-4.5xl font-medium">
                    Why do we exist?
                </div>
                        ...
                        WHY_WE_EXISTS.map((card, index) => {
                            return (
                                <div
                                    ...
                                    className="shadow-xl rounded-lg p-6 bg-white flex flex-col items-start self-stretch w-66"
                                >
                                    <img
                                        src={card.icon}
                                        alt={card.altText}
                                    ...
                                    <div className="text-1.5xl font-medium">
                                        {card.title}
                                    </div>
            ...
            <div className='flex flex-col items-center self-stretch gap-12 px-40 py-16'>
                <div className="text-center text-4.5xl font-medium">
                    What do we offer?
                </div>

                <div className="flex justify-center">
                    <div className='flex items-start justify-center flex-wrap self-stretch gap-12'>
                        <div className="flex flex-col justify-center items-start self-stretch gap-7 w-105">
                            {
                                WE_OFFER.map((content, index) => {
                                    return (
                                        <div
                                            key={index}
                                            className="bg-darkOrange flex justify-center items-center gap-2 p-5 text-white text-xl rounded-lg w-full"
                                        >
                                            {content}
                                        </div>
                                    )
            ...
            <div className='bg-darkOrange flex flex-col justify-center items-center gap-6 self-stretch px-40 py-25'>
                <div className="text-center text-white text-4.5xl font-medium">
                    Benefits
                </div>
                        ...
                        BENEFITS.map((card, index) => {
                            return (
                                <div
                                    ...
                                    className='flex flex-col justify-center items-center gap-6 shadow-xl bg-white rounded-lg p-6 h-60 w-75'
                                >
                                    <div className="flex justify-center">
                                        <img
                                            src={card.icon}
            ...
            <div className='flex items-center justify-center self-stretch gap-37 px-40 py-25'>
                <div className='flex items-center justify-center flex-wrap self-stretch gap-25'>
                    <div className="flex flex-col justify-center items-start self-stretch gap-12 w-105">
                        <div className="text-3.5xl font-semibold">
                            Partner with Us
                        </div>

                        <div className="text-xl">
                            Our commitment to high standards of quality and reliability in partnering with material testing labs simplifies the construction process and earns the trust of our clients.
                        </div>
